            ...
            <div class="hidden lg:flex items-center gap-4">
                ...
                <div class="inline-flex items-center gap-2">
                    <a href="{{ route('frontend.search-store') }}"
                        class="btn btn-primary-green text-white text-base font-medium rounded-lg">
                        Viết Review
                    </a>
                    @if (auth('web')->check())
                    ...
                    <aside x-show="open" x-transition:enter="transform transition ease-out duration-300"
                        ...
                        <div class="h-[calc(100vh-57px)] overflow-y-auto p-4">
                            <nav class="flex flex-col gap-4 py-4">
                                ...
                                <a href="{{ route('frontend.profile') }}#review" class="text-base font-bold ">Đánh
                                    giá</a>

                                <a href="{{ route('frontend.profile') }}#saved" class="text-base font-bold ">Đã lưu</a>

                                <button @click="findNearby()"
                                    class="text-base font-bold text-left flex items-center gap-2">
                                    Tìm xung quanh
                                </button>
